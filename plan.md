...
- [x] `TestParsePRSearchResult_NoCustomKeys` — standard keys only → `Custom` is empty map
- [x] `TestMergeSearchPRsResults_MergesCustom` — merges custom maps, concatenates overlapping keys
